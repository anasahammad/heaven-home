...
const OurMission = () => {
  ...
  <div className="hero-content flex-col lg:flex-row">
    <img src={ourMission} className="w-full lg:w-[55%] lg:h-[450px]  " />
    <div className="lg:w-[45%] lg:pt-14 lg:ml-6">
    <div className="flex gap-4 items-center">
            <div className="w-[65px] bg-[#D23A25] flex flex-row items-center mt-1 mb-1 h-1"></div>
            <p className="text-[#D23A25] text-xl font-semibold">Our Mission</p>
        </div>
      <h1 className="text-[25px] md:text-4xl lg:text-4xl font-bold">Elevating Real Estate: Our Commitment to You</h1>
      ...
      <button className="btn bg-[#D23A25] text-white">Learn More <BsArrowUpRight/></button>
    </div>
  </div>
</div>
        </div>
