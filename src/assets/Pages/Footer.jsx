...
const Footer = () => {
	...
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		<div className="lg:w-1/3">
			<a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
				...
				<span className="text-black text-2xl lg:text-3xl font-semibold"><span className="text-[#D23A25]">Heaven</span>Home</span>
			</a>
		</div>
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			...
			<div className="space-y-3">
				...
				<div className="flex justify-start space-x-3">
					<Link to="https://facebook.com/anasahammad.sarker"  title="Facebook" className="flex items-center p-1">
	...
	<div className="py-6 text-sm text-center dark:text-gray-600">© 2024 Anas Ahammad All rights reserved.</div>
</footer>
        </div>
    );
};
